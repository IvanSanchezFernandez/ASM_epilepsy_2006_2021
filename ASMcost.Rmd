...
total_years_pediatric <- total_DAYSUPP_pediatric / 365.24219
...
total_DAYSUPP_adult <- inflation_adjusted_ASM_epilepsy %>% 
  ...
  pull()
total_DAYSUPP_adult
total_years_adult <- total_DAYSUPP_adult / 365.24219
total_years_adult
...
ASM_cost_per_person_year_per_year_plot <- ggplot(data=ASM_cost_per_person_year_per_year) + 
  ...
  geom_line(aes(x=`year(SVCDATE)`, y=p25_AWPPPY), color="darkblue", lwd=1, lty=2) + 
  geom_line(aes(x=`year(SVCDATE)`, y=p75_AWPPPY), color="darkblue", lwd=1, lty=2) + 
  geom_ribbon(aes(x=`year(SVCDATE)`, ymin=p25_AWPPPY, ymax=p75_AWPPPY), fill="darkblue", alpha=0.1) +
  theme(legend.position="none", panel.background=element_blank(), panel.grid.major=element_blank(), panel.grid.minor=element_blank(), panel.border=element_blank(), axis.ticks=element_blank(),
        axis.text=element_text(size=14, face="bold"), axis.text.x=element_text(angle=45, hjust=1),
        axis.title=element_text(size=20, face="bold")) +
  scale_x_continuous(name="Year", breaks=2006:2021) +
...
ASM_cost_AWP_by_generic_binary_per_year_plot <- ggplot(data=ASM_cost_by_generic_binary_per_year_for_plot) + 
  ...
  scale_color_manual(values = c("generic" = "forestgreen",
                                "brand name"="red")) +
  geom_ribbon(data=ASM_cost_by_generic_binary_per_year_for_plot[ASM_cost_by_generic_binary_per_year_for_plot$generic_binary=="generic", ], aes(x=`year(SVCDATE)`, ymin=p25_AWP_per_prescription_year, ymax=p75_AWP_per_prescription_year), fill="forestgreen", alpha=0.1) +
  geom_ribbon(data=ASM_cost_by_generic_binary_per_year_for_plot[ASM_cost_by_generic_binary_per_year_for_plot$generic_binary=="brand name", ], aes(x=`year(SVCDATE)`, ymin=p25_AWP_per_prescription_year, ymax=p75_AWP_per_prescription_year), fill="red", alpha=0.1) +
  theme(legend.position="none", panel.background=element_blank(), panel.grid.major=element_blank(), panel.grid.minor=element_blank(), panel.border=element_blank(), axis.ticks=element_blank(),
        axis.text=element_text(size=14, face="bold"), axis.text.x=element_text(angle=45, hjust=1),
        axis.title=element_text(size=20, face="bold")) +
  scale_x_continuous(name="Year", breaks=2006:2021) +
...
ASM_cost_patient_cost_by_generic_binary_per_year_plot <- ggplot(data=ASM_cost_by_generic_binary_per_year_for_plot) + 
  ...
  scale_color_manual(values = c("generic" = "forestgreen",
                                "brand name"="red")) +
  geom_ribbon(data=ASM_cost_by_generic_binary_per_year_for_plot[ASM_cost_by_generic_binary_per_year_for_plot$generic_binary=="generic", ], aes(x=`year(SVCDATE)`, ymin=p25_patient_cost_per_prescription_year, ymax=p75_patient_cost_per_prescription_year), fill="forestgreen", alpha=0.1) +
  geom_ribbon(data=ASM_cost_by_generic_binary_per_year_for_plot[ASM_cost_by_generic_binary_per_year_for_plot$generic_binary=="brand name", ], aes(x=`year(SVCDATE)`, ymin=p25_patient_cost_per_prescription_year, ymax=p75_patient_cost_per_prescription_year), fill="red", alpha=0.1) +
  theme(legend.position="none", panel.background=element_blank(), panel.grid.major=element_blank(), panel.grid.minor=element_blank(), panel.border=element_blank(), axis.ticks=element_blank(),
        axis.text=element_text(size=14, face="bold"), axis.text.x=element_text(angle=45, hjust=1),
        axis.title=element_text(size=20, face="bold")) +
  scale_x_continuous(name="Year", breaks=2006:2021) +
...
ASM_cost_AWP_by_generic_binary_per_year_pediatric_plot <- ggplot(data=ASM_cost_by_generic_binary_per_year_pediatric_for_plot) + 
  ...
  scale_color_manual(values = c("generic" = "forestgreen",
                                "brand name"="red")) +
    geom_ribbon(data=ASM_cost_by_generic_binary_per_year_pediatric_for_plot[ASM_cost_by_generic_binary_per_year_pediatric_for_plot$generic_binary=="generic", ], aes(x=`year(SVCDATE)`, ymin=p25_AWP_per_prescription_year, ymax=p75_AWP_per_prescription_year), fill="forestgreen", alpha=0.1) +
  geom_ribbon(data=ASM_cost_by_generic_binary_per_year_pediatric_for_plot[ASM_cost_by_generic_binary_per_year_pediatric_for_plot$generic_binary=="brand name", ], aes(x=`year(SVCDATE)`, ymin=p25_AWP_per_prescription_year, ymax=p75_AWP_per_prescription_year), fill="red", alpha=0.1) +
  theme(legend.position="none", panel.background=element_blank(), panel.grid.major=element_blank(), panel.grid.minor=element_blank(), panel.border=element_blank(), axis.ticks=element_blank(),
        axis.text=element_text(size=14, face="bold"), axis.text.x=element_text(angle=45, hjust=1),
        axis.title=element_text(size=20, face="bold")) +
  scale_x_continuous(name="Year", breaks=2006:2021) +
...
ASM_cost_patient_cost_by_generic_binary_per_year_pediatric_plot <- ggplot(data=ASM_cost_by_generic_binary_per_year_pediatric_for_plot) + 
  ...
  scale_color_manual(values = c("generic" = "forestgreen",
                                "brand name"="red")) +
  geom_ribbon(data=ASM_cost_by_generic_binary_per_year_pediatric_for_plot[ASM_cost_by_generic_binary_per_year_pediatric_for_plot$generic_binary=="generic", ], aes(x=`year(SVCDATE)`, ymin=p25_patient_cost_per_prescription_year, ymax=p75_patient_cost_per_prescription_year), fill="forestgreen", alpha=0.1) +
  geom_ribbon(data=ASM_cost_by_generic_binary_per_year_pediatric_for_plot[ASM_cost_by_generic_binary_per_year_pediatric_for_plot$generic_binary=="brand name", ], aes(x=`year(SVCDATE)`, ymin=p25_patient_cost_per_prescription_year, ymax=p75_patient_cost_per_prescription_year), fill="red", alpha=0.1) +
  theme(legend.position="none", panel.background=element_blank(), panel.grid.major=element_blank(), panel.grid.minor=element_blank(), panel.border=element_blank(), axis.ticks=element_blank(),
        axis.text=element_text(size=14, face="bold"), axis.text.x=element_text(angle=45, hjust=1),
        axis.title=element_text(size=20, face="bold")) +
  scale_x_continuous(name="Year", breaks=2006:2021) +
...
ASM_cost_AWP_by_generic_binary_per_year_adult_plot <- ggplot(data=ASM_cost_by_generic_binary_per_year_adult_for_plot) + 
  ...
  scale_color_manual(values = c("generic" = "forestgreen",
                                "brand name"="red")) +
  geom_ribbon(data=ASM_cost_by_generic_binary_per_year_adult_for_plot[ASM_cost_by_generic_binary_per_year_adult_for_plot$generic_binary=="generic", ], aes(x=`year(SVCDATE)`, ymin=p25_AWP_per_prescription_year, ymax=p75_AWP_per_prescription_year), fill="forestgreen", alpha=0.1) +
  geom_ribbon(data=ASM_cost_by_generic_binary_per_year_adult_for_plot[ASM_cost_by_generic_binary_per_year_adult_for_plot$generic_binary=="brand name", ], aes(x=`year(SVCDATE)`, ymin=p25_AWP_per_prescription_year, ymax=p75_AWP_per_prescription_year), fill="red", alpha=0.1) +
  theme(legend.position="none", panel.background=element_blank(), panel.grid.major=element_blank(), panel.grid.minor=element_blank(), panel.border=element_blank(), axis.ticks=element_blank(),
        axis.text=element_text(size=14, face="bold"), axis.text.x=element_text(angle=45, hjust=1),
        axis.title=element_text(size=20, face="bold")) +
  scale_x_continuous(name="Year", breaks=2006:2021) +
...
ASM_cost_patient_cost_by_generic_binary_per_year_adult_plot <- ggplot(data=ASM_cost_by_generic_binary_per_year_adult_for_plot) + 
  ...
  scale_color_manual(values = c("generic" = "forestgreen",
                                "brand name"="red")) +
  geom_ribbon(data=ASM_cost_by_generic_binary_per_year_adult_for_plot[ASM_cost_by_generic_binary_per_year_adult_for_plot$generic_binary=="generic", ], aes(x=`year(SVCDATE)`, ymin=p25_patient_cost_per_prescription_year, ymax=p75_patient_cost_per_prescription_year), fill="forestgreen", alpha=0.1) +
  geom_ribbon(data=ASM_cost_by_generic_binary_per_year_adult_for_plot[ASM_cost_by_generic_binary_per_year_adult_for_plot$generic_binary=="brand name", ], aes(x=`year(SVCDATE)`, ymin=p25_patient_cost_per_prescription_year, ymax=p75_patient_cost_per_prescription_year), fill="red", alpha=0.1) +
  theme(legend.position="none", panel.background=element_blank(), panel.grid.major=element_blank(), panel.grid.minor=element_blank(), panel.border=element_blank(), axis.ticks=element_blank(),
        axis.text=element_text(size=14, face="bold"), axis.text.x=element_text(angle=45, hjust=1),
        axis.title=element_text(size=20, face="bold")) +
  scale_x_continuous(name="Year", breaks=2006:2021) +
